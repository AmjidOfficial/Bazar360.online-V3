...
export function CustomerMyServices({ userPhoneOrUid, userName, lang = 'en' }: CustomerMyServicesProps) {
  ...
  const getCompleteTimeline = (b: any): TimelineEvent[] => {
    ...
    return [
      ...
      { title: 'Showroom Assigned', desc: `Routed to: ${b.assignedWorkshop || 'Bazar360 HQ Showroom'}.`, date: updatedTime, completed: ['Confirmed', 'In-Progress', 'Completed'].includes(status) },
