with open('src/components/ShowroomView.tsx', 'r') as f:
    content = f.read()

target = """        {dealer.whatsapp && (
          <motion.a
...
if target in content:
    ...
    with open('src/components/ShowroomView.tsx', 'w') as f:
        f.write(content)
    print("ShowroomView Patched!")
else:
    print("Target not found in ShowroomView")
